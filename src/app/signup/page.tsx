...
export default function Page() {
    ...
    return (<section className="min-h-screen bg-hero-pattern bg-size-hero bg-position-hero p-5% pt-4 pb-8">
        ...
        <div className=" bg-hero w-[85vw] sm:w-[70vw] lg:w-[40vw] px-2 sm:px-8 lg:px-8 py-8 min-h-[80vh] mx-auto mt-8 flex flex-col items-center text-center justify-around">
            ...
            <div className=" flex flex-col w-full">
                ...
                <button type="submit" className="buttonB2 my-6" onClick={handleSubmit(onSignup)} > Únete</button>
